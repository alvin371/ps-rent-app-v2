    ...
    try {
      await apiFetch("/api/employees", {
        ...
        body: JSON.stringify({
          ...
          role: form.role as "Cashier" | "Admin" | "Manager",
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#8a93a5]">
              Add staff member and configure permissions
            </p>
          </div>
        </div>
      ...
      <div className="flex justify-end gap-3 pt-1">
        ...
        <button
          ...
          className={`rounded-lg px-5 py-2 text-sm font-semibold text-white shadow-[0_10px_18px_rgba(240,71,71,0.25)] ${
            isSubmitting ? "cursor-not-allowed bg-[#f6a0a0]" : "bg-[#f04747]"
          }`}
        >
